...
<pre>
bin/plugin -url https://github.com/mthmulders/elasticsearch-jetty/releases/download/1.4.4-beta/elasticsearch-jetty-1.4.4-beta.zip -install elasticsearch-jetty-1.4.4-beta
</pre>
